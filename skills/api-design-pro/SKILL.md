...
Use official [HTTP Semantics RFC ••••](https://www.rfc-editor.org/rfc/rfc9110), [OpenAPI Specification](https://spec.openapis.org/oas/latest.html), and [JSON Schema](https://json-schema.org/specification) for standards truth; this skill encodes **contract-first design**, **resource and action modeling**, **evolution safety**, and **operationally practical API conventions**. Confirm **API style** (REST/RPC/event), **client ecosystem**, and **compatibility constraints** from the project.
