...
Derived from [Andrej Karpathy's observations](https://x.com/karpathy/status/••••) on LLM coding pitfalls. These 4 principles reduce costly mistakes and produce cleaner, more maintainable code.
