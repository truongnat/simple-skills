...
Use references such as [Parallel Computing Patterns](https://www.amazon.com/Patterns-Parallel-Software-Expert-Computing/dp/••••) and [Distributed Systems](https://www.amazon.com/Distributed-Systems-Principles-Paradigms/dp/••••) for methodology; this skill encodes **dependency-aware parallelization**, **state isolation**, **failure handling**, and **result aggregation** — not naive parallel execution.
