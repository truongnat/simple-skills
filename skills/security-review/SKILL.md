...
4. src/components/UserInput.tsx:67 - XSS Vulnerability
   ...
   Reference: OWASP A03:•••• – Injection (XSS)
...
CRITICAL: axios@•••• - Server-Side Request Forgery (CVE-••••)
  Installed: axios@••••
  Fix: npm install axios@••••

HIGH: lodash@•••• - Prototype Pollution (CVE-••••)
  Installed: lodash@••••
...
### Cryptography
- [ ] Strong algorithms used (AES-256, RSA-••••+)
