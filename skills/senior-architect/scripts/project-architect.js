#!/usr/bin/env node
// Project Architect — scaffolding tool for senior architect tasks
...
class ProjectArchitect {
  ...
  run() {
    console.log(`Running ProjectArchitect...`);
...
const tool = new ProjectArchitect(targetPath, values.verbose);
