...
Use references such as [Kent Beck's TDD](https://www.amazon.com/Test-Driven-Development-Addison-Wesley-Signature/dp/••••) and [Growing Object-Oriented Software](https://www.amazon.com/Growing-Object-Oriented-Software-Guided-Tests/dp/••••) for methodology; this skill encodes **RED-GREEN-REFACTOR discipline**, **test design principles**, **refactoring safety**, and **test quality standards** — not generic "write more tests" advice.
