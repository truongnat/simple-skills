...
- **compliant_component**: Following 8px grid, •••• color
...
3. **Apply:** Base tokens (8px, ••••, 1.25 type scale)
...
- `/skills/ui-stack-pro/references/color-system.md` — •••• implementation
